...
$(function(){
	...
	newpassword.on("focus",function(){
		validateTip(newpassword.next(),{"color":"#666666"},"* 密码长度必须是大于1小于20",false);
	}).on("blur",function(){
		if(newpassword.val() != null && newpassword.val().length > 1
	...
	rnewpassword.on("focus",function(){
		...
		if(rnewpassword.val() != null && rnewpassword.val().length > 1
